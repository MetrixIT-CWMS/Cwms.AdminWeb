...
const AdminUserEditComponent = (props) => {
  const { name, refUID, emID, mobNum, mobCc, gender, dobStr, errMsg, error, type } = props.state;
  const { setStateData, handleUpdateUser, handleEditClose } = props;
  ...
  return (
    <div className='page-header'>
      ...
      <div className='d-flex justify-content-center'>
        <button type='button' className='btn btn-danger me-2' onClick={handleEditClose}>Cancel</button>
